...
(function (root, factory) {
  ...
  const KEYWORDS = new Set(["it", "in", "if", "orif", "noif", "point", "to", "fr", "and", "or", "not", "for", "fn", "global", "raw", "g"]);
  const TYPES = new Set(["t", "p", "s", "b", "text", "img", "sub", "body", "link", "int", "float", "str", "bool", "list", "dict", "tuple"]);
